import{_ as n,o as a,c as e,ae as p}from"./chunks/framework.BIONGpTb.js";const u=JSON.parse('{"title":"SSE","description":"","frontmatter":{},"headers":[],"relativePath":"webNet/SSE.md","filePath":"webNet/SSE.md"}'),t={name:"webNet/SSE.md"};function l(c,s,i,r,o,d){return a(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="sse" tabindex="-1">SSE <a class="header-anchor" href="#sse" aria-label="Permalink to &quot;SSE&quot;">​</a></h1><h2 id="sse是什么-全称server-sent-events-是个服务器向客户端传输数据的技术。通过http协议与客户端建立起长久的可持续化连接。与ws不同的是-sse中只能由服务端向客户端发送消息和数据" tabindex="-1">sse是什么？全称Server sent-Events，是个服务器向客户端传输数据的技术。通过http协议与客户端建立起长久的可持续化连接。与ws不同的是，sse中只能由服务端向客户端发送消息和数据 <a class="header-anchor" href="#sse是什么-全称server-sent-events-是个服务器向客户端传输数据的技术。通过http协议与客户端建立起长久的可持续化连接。与ws不同的是-sse中只能由服务端向客户端发送消息和数据" aria-label="Permalink to &quot;sse是什么？全称Server sent-Events，是个服务器向客户端传输数据的技术。通过http协议与客户端建立起长久的可持续化连接。与ws不同的是，sse中只能由服务端向客户端发送消息和数据&quot;">​</a></h2><p>SSE 是HTML5规范的一部分，该规范非常简单，主要由两部分组成：第一部分是服务端与浏览器端的通讯协议（Http协议），第二部分是浏览器端可供JavaScript使用的EventSource对象。</p><h2 id="node服务端实现" tabindex="-1">node服务端实现 <a class="header-anchor" href="#node服务端实现" aria-label="Permalink to &quot;node服务端实现&quot;">​</a></h2><h2 id="sse服务端的实现和http请求基本一致-只需要在服务端设置请求头-content-type-text-event-stream-即可表示我即将建立一个sse连接" tabindex="-1">sse服务端的实现和http请求基本一致，只需要在服务端设置请求头<code>&#39;content-type&#39;:&#39;text/event-stream&#39;</code>，即可表示我即将建立一个sse连接 <a class="header-anchor" href="#sse服务端的实现和http请求基本一致-只需要在服务端设置请求头-content-type-text-event-stream-即可表示我即将建立一个sse连接" aria-label="Permalink to &quot;sse服务端的实现和http请求基本一致，只需要在服务端设置请求头\`&#39;content-type&#39;:&#39;text/event-stream&#39;\`，即可表示我即将建立一个sse连接&quot;">​</a></h2><p>服务端发送数据时，数据通过几个消息发送，1是发送这个数据的媒体类型，默认是message。2是数据data，也可以带上时间等字段。消息之间用两个换行隔开。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>app.get(&#39;/api/sse&#39;, (req, res) =&gt; {</span></span>
...
<span class="line"><span>                </span></span>
<span class="line"><span>            })</span></span>
<span class="line"><span>        }</span></span></code></pre></div>`,17)])])}const v=n(t,[["render",l]]);export{u as __pageData,v as default};
